...
int main(int argc, char *argv) {
  ...
  size_t work_items[3] = {4,4,4};
  size_t workgroup_size[3] = {4,4,1};

  err = clEnqueueNDRangeKernel(cmd_queue, kernel, 3, NULL, work_items, workgroup_size, 0, NULL, NULL); CHK_ERROR(err);
